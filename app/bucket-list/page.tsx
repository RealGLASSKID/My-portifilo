...
const GROUPS: Group[] = [
  {
    ...
    items: [
      ...
      { title: "Build my first real website", tag: "career", year: "2022", desc: "The one that made it click. Terrible code, life-changing moment.", done: true },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "1M streams on a single track", tag: "music", desc: "One song that finds its people." },
