...
// TODO(auth): every function below runs with full admin privileges (the
// Firebase Admin SDK bypasses Firestore security rules entirely). Once
// /admin has auth, wrap these in a session check — right now anything that
// can call these Server Actions can write/delete freely.
